...
<body>
    <div class="wrapper">
        <header>
            ...
            <div class="kategori">
                <a id="judul_kat">Nusa Tenggara</a>
                <a id="sub_judul">“Lombok and Bali are the most beautiful place in Nusa Tenggara, the food too.”</a>
                <div class="makanan1">
                    <div class="kotak_daerah">
                        <a href="#"><img src="{{asset('img\kat4.png')}}"></a>
