        ...
        <header>
            ...
            <div class="signup">
                ...
                <form method = "POST" action = {{route('register')}}>
                    {{csrf_field()}}@if($errors->has('first_name'))
                        <div class="invalid-feedback">
                            {{$errors->first('first_name')}}
                        </div>
                    @endif
                    <input id="first-name" class="kotak_fn" type="text" name="first_name" autocomplete="off" placeholder="FIRST NAME" required />
                    @if($errors->has('last_name'))
                        <div class="invalid-feedback">
                            {{$errors->first('last_name')}}
                        </div>
                    @endif
                    <input id="last-name" class="kotak_ln" type="text" name="last_name" autocomplete="off" placeholder="LAST NAME" required />
