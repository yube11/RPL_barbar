...
<body>
    ...
    <div class="wrapper">
        <header>
            ...
            <div class="kategori">
                <a id="judul_kat">Sulawesi</a>
                <a id="sub_judul">“Sulawesi is the island where Lely came from.”</a>
                @foreach($posts as $post)
                <div class="makanan1">
                    <div class="kotak_daerah">
                        <a href="/rpl-tuman/public/article/sulawesi/{{$post->slug}}"><img src="{{asset('img/kat5.png')}}"></a>
                        <a id="daerah">{{$post->tittle}}</a>
                        <a id="tanggal">{{$post->created_at->format('d/m/Y')}}</a>
                        <a href="/rpl-tuman/public/article/sulawesi/{{$post->slug}}" id="more">Read More ›</a>
                    </div>
                </div>
                @endforeach
            </div>
