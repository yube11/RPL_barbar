...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="isi">
            <a id="judul">{{$kalimantan->tittle}}</a>
            <a id="writer">{{$kalimantan->admin->nama}}, {{$kalimantan->created_at->format('d/m/Y')}}</a>
